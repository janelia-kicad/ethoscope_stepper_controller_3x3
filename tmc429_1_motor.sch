...
AR Path="/5BA14F01/5BA151EE/5B754166" Ref="U11"  Part="1" 
F 0 "U11" H 2450 3700 60  0000 C CNN
F 1 "TMC429" H 1750 3700 60  0000 C CNN
F 2 "ethoscope_stepper_controller_3x3:QFN-5x5-32" H 2350 3600 60  0001 C CNN
...
AR Path="/5BA14F01/5BA151EE/5B75417B" Ref="#PWR098"  Part="1" 
F 0 "#PWR098" H 2100 1400 50  0001 C CNN
...
AR Path="/5BA14F01/5BA151EE/5B754186" Ref="#PWR099"  Part="1" 
F 0 "#PWR099" H 2100 3700 50  0001 C CNN
...
AR Path="/5BA14F01/5BA151EE/5B754198" Ref="C22"  Part="1" 
F 0 "C22" H 1200 1500 40  0000 L CNN
F 1 "0.1uF" H 1200 1400 30  0000 C CNN
F 2 "ethoscope_stepper_controller_3x3:SM0402" H 1238 1250 30  0001 C CNN
F 3 "" H 1200 1400 60  0000 C CNN
F 4 "digikey" H 1300 1600 60  0001 C CNN "Vendor"
F 5 "1276-1739-1-ND" H 1400 1700 60  0001 C CNN "PartNumber"
F 6 "CAP CER 0.1UF 25V Y5V 0402" H 1500 1800 60  0001 C CNN "Description"
	1    1200 1400
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5BA14F01/5BA151EE/5B75419F" Ref="#PWR096"  Part="1" 
F 0 "#PWR096" H 1200 1000 50  0001 C CNN
...
AR Path="/5BA14F01/5BA151EE/5B7541A5" Ref="#PWR097"  Part="1" 
F 0 "#PWR097" H 1200 1400 50  0001 C CNN
...
AR Path="/5BA14F01/5BA151EE/5B7541BF" Ref="#PWR0105"  Part="1" 
...
AR Path="/5BA14F01/5BA151EE/5B7541C5" Ref="#PWR0104"  Part="1" 
F 0 "#PWR0104" H 3250 2700 50  0001 C CNN
...
AR Path="/5BA14F01/5BA151EE/5B7541CB" Ref="#PWR0103"  Part="1" 
F 0 "#PWR0103" H 3250 2200 50  0001 C CNN
...
AR Path="/5BA14F01/5BA151EE/5B7541E8" Ref="U12"  Part="1" 
F 0 "U12" H 2750 5450 40  0000 L CNN
F 1 "BUFFER_TRI_STATE" H 2700 4650 40  0000 L CNN
F 2 "ethoscope_stepper_controller_3x3:SOT-23-5" H 2650 5050 60  0001 C CNN
...
AR Path="/5BA14F01/5BA151EE/5B7541EF" Ref="#PWR0100"  Part="1" 
F 0 "#PWR0100" H 2650 4400 50  0001 C CNN
...
AR Path="/5BA14F01/5BA151EE/5B7541F5" Ref="#PWR0101"  Part="1" 
F 0 "#PWR0101" H 2650 5300 50  0001 C CNN
...
AR Path="/5BA14F01/5BA151EE/5B754203" Ref="R15"  Part="1" 
F 0 "R15" H 2950 1100 40  0000 L CNN
F 1 "10.0k" V 2900 1100 40  0000 C CNN
F 2 "ethoscope_stepper_controller_3x3:SM0402" V 2830 1100 30  0001 C CNN
F 3 "" H 2900 1100 30  0000 C CNN
F 4 "digikey" V 3080 1200 60  0001 C CNN "Vendor"
F 5 "P10KJCT-ND" V 3180 1300 60  0001 C CNN "PartNumber"
F 6 "RES SMD 10K OHM 5% 1/10W 0402" V 3280 1400 60  0001 C CNN "Description"
	1    2900 1100
	1    0    0    -1  
$EndComp
Wire Wire Line
...
AR Path="/5BA14F01/5BA151EE/5B75420F" Ref="#PWR0102"  Part="1" 
